...
ruta_archivo_rds <- paste("X_se_Muestras_", Distribucion, "_Positiva_", error, "_", N, ".rds", sep = "")

X_se <- readRDS(ruta_archivo_rds)
y <- read.csv(paste("y_Muestras_", Distribucion, "_Positiva_", error, "_", N, ".csv", sep = ""), dec = ".")
Beta_real <- read.csv(paste("Beta_Muestras_", Distribucion, "_Positiva_", error, "_", N, ".csv", sep = ""), dec = ".")
t <- read.csv(paste("T_Muestras_", Distribucion, "_Positiva_", error, "_", N, ".csv", sep = ""), dec = ".")
Beta_real_2 <- read.csv(paste("Beta2_Muestras_", Distribucion, "_Positiva.csv", sep = ""), dec = ".")
T2 <- read.csv(paste("T2_Muestras_", Distribucion, "_Positiva.csv", sep = ""), dec = ".")
T2 <- as.vector(T2$x)
...
plot(results_constrained$mean, col = "black", type = "l", ylim = range(c(results_constrained$lower, results_constrained$upper, Beta_real$x)), ylab = "Valor", xlab = "Índice")
