...
betaT<-dnorm(T, mean=1/2, sd = 0.1) # Simulación Normal
...
saveRDS(object = X_se_Muestras, file = "X_se_Muestras_Normal_Positiva_001_125.rds")
Importacion <- readRDS(file = "X_se_Muestras_Normal_Positiva_001_125.rds")
write.csv(betaT, file = "Beta_Muestras_Normal_Positiva_001_125.csv", row.names = FALSE)
write.csv(T, file = "T_Muestras_Normal_Positiva_001_125.csv", row.names = FALSE)
write.csv(T2, file = "T2_Muestras_Pareto_Positiva.csv", row.names = FALSE)
write.csv(betaT2, file = "Beta2_Muestras_Pareto_Positiva.csv", row.names = FALSE)
write.csv(y_Muestras, file = "y_Muestras_Normal_Positiva_001_125.csv", row.names = FALSE)
